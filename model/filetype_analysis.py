        ...
        if img.mode == "RGBA":
            ...
            for y in range(alpha.height):
                for x in range(alpha.width):
                    print(
                        f"({red.getpixel((x, y))}, {green.getpixel((x, y))}, {blue.getpixel((x, y))}, {alpha.getpixel((x, y))})",
                        end=" ",
                    )
                    print()
...
def get_filepaths(base_filepath, folder):
    return [
        os.path.join(base_filepath, folder, file)
        for file in os.listdir(path=os.path.join(base_filepath, folder))
    ]
...
def main():
    ...
    get_dataset_info(
        ...
        filepaths=get_filepaths(
            os.path.join("data", "train", "cleanTrain"), folder="nonrgb"
        ),
    ...
    get_dataset_info(
        name="nonrgb test",
        filepaths=get_filepaths(
            os.path.join("data", "train", "cleanTest"), folder="nonrgb"
        ),
        print_dimensions=False,
    )
